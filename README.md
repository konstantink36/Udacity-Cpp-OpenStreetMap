...
The Route Planner finds the shortest path between two points on a map using the A* search algorithm. 
...
- Read the map data from an .OSM xml file
...
- The path is returned and plotted using the IO2D library
